...
export function generateBuildScript(
  ...
  sections.push('      "$_prefix/venv/bin/pip" install --upgrade pip setuptools wheel || echo "[buildkit] WARN: setuptools install failed" >&2')
  ...
  sections.push('  "$prefix/venv/bin/pip" install --upgrade pip setuptools wheel || echo "[buildkit] WARN: setuptools install failed" >&2')
