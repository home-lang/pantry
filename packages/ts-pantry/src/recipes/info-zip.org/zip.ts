...
export const recipe: Recipe = {
  ...
  build: {
    script: [
      ...
      'patch -p1 < patch/debian/patches/11-typo-it-is-ambiguities-not-amgibuities.patch',
      'make -f unix/Makefile CC={{deps.gnu.org/gcc.prefix}}/bin/gcc generic CFLAGS="-fcommon -O2"',
