...
export const recipe: Recipe = {
  ...
  programs: ['mudraw', 'mupdf-gl', 'mutool'],
  versionSource: {
    type: 'github-tags',
  ...
  distributable: {
    ...
    // pkgx pins the git checkout to the requested tag (`ref: ${{version}}`).
    // The buildkit reads `distributable.ref` to build the right version
  ...
  build: {
    script: [
      ...
      {
        run: 'sed -i.bak \'s|"\\.\\./thirdparty/mujs/regexp\\.h"|"../../thirdparty/mujs/regexp.h"|\' stext-search.c',
