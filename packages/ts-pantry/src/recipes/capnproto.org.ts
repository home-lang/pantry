...
export const recipe: Recipe = {
  ...
  build: {
    ...
    env: {
      'CMAKE_ARGS': ['-DCMAKE_CXX_STANDARD=20', '-DCMAKE_INSTALL_RPATH={{prefix}}/lib', '-DCMAKE_INSTALL_PREFIX={{prefix}}', '-DCMAKE_INSTALL_LIBDIR={{prefix}}/lib', '-DCMAKE_BUILD_TYPE=Release', '-Wno-dev', '-DCMAKE_CXX_FLAGS=-fPIC', '-DCMAKE_POSITION_INDEPENDENT_CODE=ON', '-DBUILD_TESTING=OFF'],
    },
  },
}
