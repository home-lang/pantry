...
export const recipe: Recipe = {
  ...
  build: {
    script: [
      ...
      '    case $VERSION in',
      '    4.1.2)',
      '      URL=https://archive.docbook.org/xml/${VERSION}/docbkx412.zip',
      '      ;;',
      '    4.*)',
      '      URL=https://archive.docbook.org/xml/${VERSION}/docbook-xml-${VERSION}.zip',
      '      ;;',
      '    5.0)',
      '      URL=https://archive.docbook.org/xml/${VERSION}/docbook-${VERSION}.zip',
      '      ;;',
      '    *)',
      '      URL=https://archive.docbook.org/xml/${VERSION}/docbook-v${VERSION}-os.zip',
      '      ;;',
      '    esac',
      '    curl -fL -o docbook-$VERSION.zip $URL',
