    ...
    script: [
      {
        run: [
          ...
          'for url in "${urls[@]}"; do',
          '  # ftp.gnu.org is flaky from CI (connect timeouts); use the ftpmirror redirector',
          '  # that the source tarball already downloads through, and add retries/timeouts so a',
          '  # transient hiccup retries instead of hanging for minutes and failing the build.',
