 ...
 *
 * @install `pantry install github.com/regclient/regclient/regctl`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/regclient/regclient/regctl.md
...
export const regctlPackage = {
  ...
  */
  installCommand: 'pantry install github.com/regclient/regclient/regctl' as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) +github.com/regclient/regclient/regctl -- $SHELL -i' as const,
  pantryInstallCommand: 'pantry install github.com/regclient/regclient/regctl' as const,
  /**
