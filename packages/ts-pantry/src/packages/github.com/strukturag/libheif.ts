 ...
 * @version `1.21.2` (26 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install github.com/strukturag/libheif`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/strukturag/libheif.md
