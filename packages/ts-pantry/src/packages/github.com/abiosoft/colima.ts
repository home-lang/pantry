 ...
 * @programs `colima`
 * @version `0.10.1` (29 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install github.com/abiosoft/colima`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/abiosoft/colima.md
