 ...
 * @programs `mkdocs`
 * @version `9.7.6` (77 versions available)
 ...
 * console.log(pkg.versions[0]) // "9.7.6" (latest)
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/squidfunk/mkdocs-material.md
