 ...
 * @version `3.18.2` (8 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install github.com/libfuse/libfuse`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/libfuse/libfuse.md
