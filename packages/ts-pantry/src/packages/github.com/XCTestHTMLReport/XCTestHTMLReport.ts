 ...
 *
 * @install `pantry install github.com/XCTestHTMLReport/XCTestHTMLReport`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/XCTestHTMLReport/XCTestHTMLReport.md
