 ...
 *
 * @install `launchpad install github.com/ToruNiina/toml11`
 ...
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/github-com/ToruNiina/toml11.md
...
export const toml11Package = {
  ...
  */
  installCommand: 'launchpad install github.com/ToruNiina/toml11' as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) +github.com/ToruNiina/toml11 -- $SHELL -i' as const,
  launchpadInstallCommand: 'launchpad install github.com/ToruNiina/toml11' as const,
  programs: [] as const,
  companions: [] as const,
