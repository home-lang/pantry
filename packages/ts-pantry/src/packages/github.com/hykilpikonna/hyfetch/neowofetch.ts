 ...
 *
 * @install `pantry install github.com/hykilpikonna/hyfetch/neowofetch`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/hykilpikonna/hyfetch/neowofetch.md
