 ...
 * @version `2.6.0` (13 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install github.com/deepmap/oapi-codegen`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/deepmap/oapi-codegen.md
