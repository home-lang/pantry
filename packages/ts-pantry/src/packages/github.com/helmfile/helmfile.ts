 ...
 * @programs `helmfile`
 * @version `1.4.2` (42 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install github.com/helmfile/helmfile`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/helmfile/helmfile.md
