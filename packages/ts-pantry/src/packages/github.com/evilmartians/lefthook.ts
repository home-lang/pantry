 ...
 * @programs `lefthook`
 * @version `2.1.4` (151 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install github.com/evilmartians/lefthook`
 ...
 * console.log(pkg.versions[0]) // "2.1.4" (latest)
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/evilmartians/lefthook.md
