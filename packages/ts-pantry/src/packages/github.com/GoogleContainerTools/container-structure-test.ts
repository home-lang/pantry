 ...
 *
 * @install `pantry install github.com/GoogleContainerTools/container-structure-test`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/github-com/GoogleContainerTools/container-structure-test.md
