 ...
 *
 * @install `pantry install freedesktop.org/xcb-util-renderutil`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/freedesktop-org/xcb-util-renderutil.md
...
export const freedesktoporgxcbutilrenderutilPackage = {
  ...
  */
  installCommand: 'pantry install freedesktop.org/xcb-util-renderutil' as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) +freedesktop.org/xcb-util-renderutil -- $SHELL -i' as const,
  pantryInstallCommand: 'pantry install freedesktop.org/xcb-util-renderutil' as const,
  programs: [] as const,
  companions: [] as const,
  /**
