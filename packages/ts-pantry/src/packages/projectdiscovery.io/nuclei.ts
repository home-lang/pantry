 ...
 * @programs `nuclei`
 * @version `3.7.1` (16 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install projectdiscovery.io/nuclei`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/projectdiscovery-io/nuclei.md
