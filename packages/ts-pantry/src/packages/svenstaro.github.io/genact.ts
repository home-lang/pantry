 ...
 * @programs `genact`
 * @version `1.5.1` (7 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install svenstaro.github.io/genact`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/svenstaro-github-io/genact.md
