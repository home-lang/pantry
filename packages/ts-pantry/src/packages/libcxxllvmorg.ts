 ...
 * @version `22.1.1` (53 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install libcxx.llvm.org`
...
export const libcxxllvmorgPackage = {
  ...
  */
  installCommand: 'pantry install libcxx.llvm.org' as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) +libcxx.llvm.org -- $SHELL -i' as const,
  pantryInstallCommand: 'pantry install libcxx.llvm.org' as const,
  programs: [] as const,
  companions: [] as const,
