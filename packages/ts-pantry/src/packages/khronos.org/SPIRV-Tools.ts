 ...
 * @version `2026.1.0` (7 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install khronos.org/SPIRV-Tools`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/khronos-org/SPIRV-Tools.md
