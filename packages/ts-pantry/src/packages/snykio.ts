 ...
 * @domain `snyk.io`
 * @programs `snyk`
 * @version `1.1303.1` (59 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install snyk.io`
 ...
 * console.log(pkg.versions[0]) // "1.1303.1" (latest)
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/snyk-io.md
