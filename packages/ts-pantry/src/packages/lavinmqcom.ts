 ...
 * @version `2.6.8` (27 versions available)
 ...
 * @buildDependencies `lz4.org@^1`, `gnu.org/help2man`, `perl.org@=5.42.0`, ... (+1 more) - required only when building from source
 *
 * @example
 * ```typescript
 ...
 * console.log(pkg.versions[0]) // "2.6.8" (latest)
 * ```
 *
