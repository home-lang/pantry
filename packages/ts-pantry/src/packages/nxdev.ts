 ...
 * @domain `nx.dev`
 * @programs `nx`
 * @version `22.6.1` (224 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install nx.dev`
 ...
 * console.log(pkg.versions[0]) // "22.6.1" (latest)
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/nx-dev.md
