 ...
 * @version `0.37.1` (107 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install quary.dev/sqruff`
 ...
 * console.log(pkg.versions[0]) // "0.37.1" (latest)
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/quary-dev/sqruff.md
...
export const quarydevsqruffPackage = {
  ...
  */
  installCommand: 'pantry install quary.dev/sqruff' as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) +quary.dev/sqruff -- $SHELL -i' as const,
  pantryInstallCommand: 'pantry install quary.dev/sqruff' as const,
  /**
