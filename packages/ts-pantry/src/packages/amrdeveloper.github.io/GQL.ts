 ...
 * @programs `gitql`
 * @version `0.43.0` (37 versions available)
 * @versions From newest version to oldest.
 *
 * @install `pantry install amrdeveloper.github.io/GQL`
 ...
 * ```
 *
 * @see https://ts-pantry.netlify.app/packages/amrdeveloper-github-io/GQL.md
