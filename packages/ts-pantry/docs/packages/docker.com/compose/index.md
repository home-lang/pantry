...
```bash
# Install with pantry
pantry install docker.com/compose
```
...
- `2.37.3`, `2.37.2`, `2.37.1`, `2.37.0`
- `2.36.2`, `2.36.1`, `2.36.0`
- `2.35.1`, `2.35.0`
- `2.34.0`
- `2.33.1`, `2.33.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +docker.com/compose@5.1.1 -- $SHELL -i
```
