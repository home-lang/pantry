...
```bash
# Install with pantry
pantry install microsoft.com/azure-storage-azcopy
```
...
**Latest Version**: `10.32.2`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +microsoft.com/azure-storage-azcopy@10.32.2 -- $SHELL -i
```
