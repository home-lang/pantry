...
<details>
<summary>Show all 502 versions</summary>

- `0.4.14`, `0.4.13`, `0.4.12`, `0.4.11`, `0.4.10`, `0.4.9`, `0.4.8`, `0.4.7`, `0.4.6`, `0.4.5`, `0.4.4`, `0.4.3`, `0.4.2`, `0.4.1`, `0.4.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +fly.io@0.4.14 -- $SHELL -i
```
