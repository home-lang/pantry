...
```bash
# Install with pantry
pantry install onsi.github.io/ginkgo
```
...
- `2.28.1`, `2.28.0`
- `2.27.5`, `2.27.4`, `2.27.3`, `2.27.2`, `2.27.1`, `2.27.0`
- `2.26.0`
- `2.25.3`, `2.25.2`, `2.25.1`, `2.25.0`
- `2.24.0`
- `2.23.4`, `2.23.3`, `2.23.2`, `2.23.1`, `2.23.0`
- `2.22.2`, `2.22.1`, `2.22.0`
- `2.21.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +onsi.github.io/ginkgo@2.28.1 -- $SHELL -i
```
