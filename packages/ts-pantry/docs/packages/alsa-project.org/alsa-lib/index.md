...
- `1.2.15.3`, `1.2.15.2`, `1.2.15.1`, `1.2.14`, `1.2.13`, `1.2.12`, `1.2.11`, `1.2.10`, `1.2.9`

</details>

**Latest Version**: `1.2.15.3`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +alsa-project.org/alsa-lib@1.2.15.3 -- $SHELL -i
```
