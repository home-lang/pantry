...
- `4.5.0`, `4.4.0`, `4.3.3`, `4.3.2`, `4.3.1`
- `4.3.0`, `4.2.1`, `4.2.0`, `4.1.2`, `4.1.1`
- `4.1.0`, `4.0.9`, `4.0.8`, `4.0.6`, `4.0.2`
- `4.0.1`, `4.0.0`, `3.7.1`, `3.7.0`, `3.6.4`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +fishshell.com@4.5.0 -- $SHELL -i
```
