...
- `2025.2.3.0`, `2025.2.24.0`, `2025.2.17.0`, `2025.2.10.0`
...
- `2024.6.3.0`, `2024.6.24.0`, `2024.6.17.0`, `2024.6.10.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +facebook.com/folly@2026.2.9.0 -- $SHELL -i
```
