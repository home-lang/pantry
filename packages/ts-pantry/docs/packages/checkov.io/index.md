...
**Latest Version**: `3.2.502`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +checkov.io@3.2.502 -- $SHELL -i
```
