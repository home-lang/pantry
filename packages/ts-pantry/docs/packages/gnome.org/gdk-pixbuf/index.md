...
```bash
# Install with pantry
pantry install gnome.org/gdk-pixbuf
```
...
- `2.44.5`, `2.44.4`, `2.44.3`, `2.44.2`, `2.44.1`, `2.44.0`
- `2.43.5`, `2.43.3`, `2.43.2`
- `2.42.9`, `2.42.8`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +gnome.org/gdk-pixbuf@2.44.5 -- $SHELL -i
```
