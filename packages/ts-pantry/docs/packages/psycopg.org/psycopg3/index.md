...
```bash
# Install with pantry
pantry install psycopg.org/psycopg3
```
...
- `3.2.13`, `3.2.12`, `3.2.11`, `3.2.10`, `3.2.9`, `3.2.8`, `3.2.7`, `3.2.6`, `3.2.5`, `3.2.4`, `3.2.3`, `3.2.2`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +psycopg.org/psycopg3@3.3.3 -- $SHELL -i
```
