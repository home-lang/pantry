...
```bash
# Install with pantry
pantry install gitlab.com/gitlab-org/cli
```
...
- `1.82.0`
- `1.81.0`
- `1.80.4`, `1.80.3`, `1.80.2`, `1.80.1`, `1.80.0`
- `1.79.0`
- `1.78.3`, `1.78.2`, `1.78.1`, `1.78.0`
- `1.77.0`
- `1.76.2`, `1.76.1`, `1.76.0`
- `1.75.0`
- `1.74.0`
- `1.73.1`, `1.73.0`
- `1.72.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +gitlab.com/gitlab-org/cli@1.89.0 -- $SHELL -i
```
