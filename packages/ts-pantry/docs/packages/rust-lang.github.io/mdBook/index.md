...
```bash
# Install with pantry
pantry install rust-lang.github.io/mdBook
```
...
- `0.5.2`, `0.5.1`, `0.5.0`
- `0.4.52`, `0.4.51`, `0.4.50`, `0.4.49`, `0.4.48`, `0.4.47`, `0.4.46`, `0.4.45`, `0.4.44`, `0.4.43`, `0.4.42`, `0.4.41`, `0.4.40`, `0.4.39`, `0.4.38`, `0.4.37`, `0.4.36`, `0.4.35`, `0.4.34`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +rust-lang.github.io/mdBook@0.5.2 -- $SHELL -i
```
