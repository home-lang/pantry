...
- `5.1.0`, `5.0.2`, `5.0.1`, `5.0.0`, `4.1.2`
- `4.1.1`, `4.1.0`, `4.0.0`, `3.1.0`, `3.0.1`
- `3.0.0`, `2.3.0`, `2.2.2`, `2.2.1`, `2.2.0`
- `2.1.0`, `2.0.0`, `1.9.0`, `1.8.8`, `1.8.7`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/mas-cli/mas@5.1.0 -- $SHELL -i
```
