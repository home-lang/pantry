...
- `0.7.11`, `0.7.10`, `0.7.9`, `0.7.8`, `0.7.7`, `0.7.6`, `0.7.5`, `0.7.4`, `0.7.3`, `0.7.2`, `0.7.1`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/kubernetes-sigs/aws-iam-authenticator@0.7.11 -- $SHELL -i
```
