...
```bash
# Install with pantry
pantry install github.com/junegunn/fzf
```
...
- `0.63.0`
- `0.62.0`
- `0.61.3`, `0.61.2`, `0.61.1`, `0.61.0`
- `0.60.3`, `0.60.2`, `0.60.1`, `0.60.0`
- `0.59.0`
- `0.58.0`
- `0.57.0`
- `0.56.3`, `0.56.2`, `0.56.1`, `0.56.0`
- `0.55.0`
- `0.54.3`, `0.54.2`, `0.54.1`, `0.54.0`
- `0.53.0`
- `0.52.1`, `0.52.0`
- `0.51.0`
- `0.50.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/junegunn/fzf@0.70.0 -- $SHELL -i
```
