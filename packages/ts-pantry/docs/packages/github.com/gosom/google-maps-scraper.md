...
```bash
# Install with pantry
pantry install github.com/gosom/google-maps-scraper
```
...
- `1.7.14`, `1.7.13`, `1.7.12`, `1.7.10`, `1.7.9`, `1.7.8`, `1.7.7`, `1.7.6`, `1.7.5`, `1.7.4`, `1.7.3`, `1.7.2`, `1.7.1`, `1.7.0`
- `1.6.1`, `1.6.0`
- `1.5.3`, `1.5.2`, `1.5.1`, `1.5.0`
- `1.4.2`, `1.4.1`, `1.4.0`
- `1.3.6`, `1.3.5`, `1.3.3`, `1.3.2`, `1.3.1`, `1.3.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/gosom/google-maps-scraper@1.11.0 -- $SHELL -i
```
