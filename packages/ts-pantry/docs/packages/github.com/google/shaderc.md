...
- `2026.1.0`, `2025.5.0`, `2025.4.0`, `2025.3.0`, `2025.2.0`
- `2025.1.0`, `2024.4.0`, `2024.3.0`, `2024.2.0`, `2024.1.0`
- `2024.0.0`, `2023.8.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/google/shaderc@2026.1.0 -- $SHELL -i
```
