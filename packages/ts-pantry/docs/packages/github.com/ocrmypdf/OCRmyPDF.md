...
```bash
# Install with pantry
pantry install github.com/ocrmypdf/OCRmyPDF
```
...
- `16.12.0`
- `16.11.1`, `16.11.0`
- `16.10.4`, `16.10.3`, `16.10.2`, `16.10.1`, `16.10.0`
- `16.7.0`
- `16.6.2`, `16.6.1`, `16.6.0`
- `16.5.0`
- `16.4.3`, `16.4.2`, `16.4.1`, `16.4.0`
- `16.3.1`, `16.3.0`
- `16.2.0`
- `16.1.2`, `16.1.1`, `16.1.0`
- `16.0.4`, `16.0.3`, `16.0.2`, `16.0.1`, `16.0.0`
- `15.4.4`, `15.4.3`, `15.4.2`, `15.4.1`, `15.4.0`
- `15.3.1`, `15.3.0`
- `15.2.0`
- `15.1.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/ocrmypdf/OCRmyPDF@17.4.0 -- $SHELL -i
```
