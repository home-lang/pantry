...
```bash
# Install with pantry
pantry install libcxx.llvm.org
```
...
- `18.1.8`, `18.1.7`, `18.1.6`, `18.1.4`, `18.1.3`, `18.1.2`, `18.1.1`
- `17.0.6`, `17.0.5`, `17.0.4`, `17.0.3`, `17.0.2`, `17.0.1`
- `16.0.6`, `16.0.5`, `16.0.4`, `16.0.3`, `16.0.2`, `16.0.1`
- `15.0.7`, `15.0.6`
- `14.0.6`, `14.0.3`
- `13.0.1`
- `12.0.1`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +libcxx.llvm.org@22.1.1 -- $SHELL -i
```
