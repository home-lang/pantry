...
- `23.0.1`, `23.0.0`, `22.0.0`, `21.0.0`, `20.0.0`
- `19.0.1`, `19.0.0`, `18.1.0`, `18.0.0`, `16.1.0`
- `16.0.0`, `15.0.2`, `15.0.1`, `15.0.0`, `14.0.2`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +apache.org/arrow@23.0.1 -- $SHELL -i
```
