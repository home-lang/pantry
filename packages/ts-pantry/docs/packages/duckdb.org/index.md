...
- `1.3.2`, `1.3.1`, `1.3.0`, `1.2.2`, `1.2.1`
- `1.2.0`, `1.1.3`, `1.1.2`, `1.1.1`, `1.1.0`
- `1.0.0`, `0.10.3`, `0.10.2`, `0.10.1`, `0.10.0`
- `0.9.2`, `0.9.1`, `0.9.0`, `0.8.1`, `0.8.0`
- `0.7.1`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +duckdb.org@1.4.4 -- $SHELL -i
```
