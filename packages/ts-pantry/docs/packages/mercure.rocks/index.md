...
- `0.21.11`, `0.21.10`, `0.21.8`, `0.21.7`, `0.21.6`, `0.21.5`, `0.21.4`, `0.21.3`, `0.21.2`, `0.21.1`, `0.21.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +mercure.rocks@0.21.11 -- $SHELL -i
```
