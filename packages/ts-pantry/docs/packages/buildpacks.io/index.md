...
- `0.40.0`, `0.39.1`, `0.39.0`, `0.38.2`, `0.38.1`
- `0.38.0`, `0.37.0`, `0.36.4`, `0.36.3`, `0.36.2`
- `0.36.1`, `0.36.0`, `0.35.1`, `0.35.0`, `0.34.2`
- `0.34.1`, `0.34.0`, `0.33.2`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +buildpacks.io@0.40.0 -- $SHELL -i
```
