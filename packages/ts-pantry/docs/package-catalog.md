...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2026-02-26T18:32:43.890Z
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.17.1 (+149) | `pkgx ollama` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.2.61 (+2747) | `pkgx vi` |
