...
This comprehensive catalog lists all 1401+ packages available in ts-pkgx, organized by category.
...
- **Total Packages**: 1401
- **Categories**: 27
- **Last Updated**: 2026-03-15T21:23:55.265Z
...
| **[just.systems](./packages/just.systems/index.md)** () | Handy way to save and run project-specific commands | just | 1.47.0 (+52) | `pkgx just` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.2.173 (+2839) | `pkgx vi` |
...
| **[planetscale.com](./packages/planetscale.com/index.md)** () | The CLI for PlanetScale Database | pscale | 0.275.0 (+97) | `pkgx pscale` |
