...
- **Total Packages**: 1457
- **Categories**: 27
- **Last Updated**: 2026-03-23T17:47:12.796Z
...
| **[postgrest.org](./packages/postgrest.org/index.md)** () | Serves a fully RESTful API from any existing PostgreSQL database | postgrest | 14.7.0 (+26) | `pkgx postgrest` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.2.231 (+2894) | `pkgx vi` |
