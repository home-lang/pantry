...
- **Total Packages**: 1401
- **Categories**: 27
- **Last Updated**: 2026-03-20T20:37:49.792Z
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.2.209 (+2873) | `pkgx vi` |
...
| **[github.com/dundee/gdu](./packages/github.com/dundee/gdu.md)** () | Fast disk usage analyzer with console interface written in Go | gdu | 5.34.1 (+7) | `pkgx gdu` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.4.25 (+512) | `pkgx fly` |
