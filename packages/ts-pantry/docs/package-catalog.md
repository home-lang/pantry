...
- **Total Packages**: 1401
- **Categories**: 27
- **Last Updated**: 2026-03-17T17:26:27.498Z
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.18.0 (+156) | `pkgx ollama` |
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 2.28.0 (+320) | `pkgx openai` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.2.184 (+2850) | `pkgx vi` |
...
| **[traefik.io](./packages/traefik.io/index.md)** () | The Cloud Native Application Proxy | traefik | 3.6.10 (+92) | `pkgx traefik` |
...
| **[yt-dlp.org](./packages/yt-dlp.org/index.md)** () | A feature-rich command-line audio/video downloader | yt-dlp | 2026.3.13 (+66) | `pkgx yt-dlp` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.4.22 (+509) | `pkgx fly` |
