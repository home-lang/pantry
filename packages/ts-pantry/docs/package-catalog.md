...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2026-02-23T19:54:43.176Z
...
| **[jupyter.org](./packages/jupyter.org/index.md)** () | JupyterLab computational environment. | jlpm, jupyter, jupyter-bundlerextension, ... (+21) | 4.5.5 (+62) | `pkgx jupyter` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[cli.github.com](./packages/cli.github.com/index.md)** () | GitHub’s official command line tool | gh | 2.87.3 (+98) | `pkgx gh` |
